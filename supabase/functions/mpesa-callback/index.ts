<<<<<<< HEAD
import { serve } from "https://deno.land/std@0.224.0/http/server.ts"`nimport { createClient } from "npm:@supabase/supabase-js"
...
=======
      const metadata = CallbackMetadata?.Item as Array<{ Name: string; Value: string | number }>
